...
UNEMBEDDING_LR = 0.005375 # learning rate for lm_head (Adam)
MATRIX_LR = 0.046 # learning rate for matrix parameters (Muon)
SCALAR_LR = 0.5         # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.2      # cautious weight decay for Muon
ADAM_BETAS = (0.85, 0.94) # Adam beta1, beta2
WARMUP_RATIO = 0.0      # fraction of time budget for LR warmup
WARMDOWN_RATIO = 0.49    # fraction of time budget for LR warmdown
