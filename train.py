...
UNEMBEDDING_LR = 0.00475 # learning rate for lm_head (Adam)
MATRIX_LR = 0.046 # learning rate for matrix parameters (Muon)
SCALAR_LR = 0.48125 # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.22 # cautious weight decay for Muon
