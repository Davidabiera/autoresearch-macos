...
export AUTORESEARCH_STAGE_ID=frontier_soak
export AUTORESEARCH_LAUNCHER="$SCRIPT_DIR/run_mar10_frontier_soak.sh"
...
exec python3 "$SCRIPT_DIR/overnight_runner.py" \
  ...
  --best-commit 5b486fb \
  --best-val 1.386688 \
  --queue /Users/davidabiera/Projects/team/autoresearch-macos/worktrees/control/control/queues/mar10_frontier_soak.jsonl \
