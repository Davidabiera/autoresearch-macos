...
export AUTORESEARCH_PLAN_PATH=/Users/davidabiera/Projects/team/autoresearch-macos/worktrees/control/control/plans/mar10_scalar_0475_confirmation.json
export AUTORESEARCH_STAGE_ID=scalar_0475_confirmation
export AUTORESEARCH_LAUNCHER="$SCRIPT_DIR/run_mar10_scalar_0475_confirmation.sh"
...
exec python3 "$SCRIPT_DIR/overnight_runner.py" \
  ...
  --best-commit a6a97d3 \
  --best-val 1.380746 \
  --queue /Users/davidabiera/Projects/team/autoresearch-macos/worktrees/control/control/queues/mar10_scalar_0475_confirmation.jsonl \
