...
class AutoresearchToolTests(unittest.TestCase):
    ...
    def test_recommended_action_holds_window_after_closed_adjacent_axes(self) -> None:
        ...
        self.assertIn("autoresearch_current_state.md", payload["recommended_next_action"])
        self.assertIn("run_gating_checklist.md", payload["recommended_next_action"])
        self.assertIn("pause/consolidate", payload["recommended_next_action"])
        self.assertIn("ridge is closed", payload["environment"]["search_blocked_reason"])
        self.assertIn("pause/consolidate", payload["environment"]["search_blocked_reason"])
